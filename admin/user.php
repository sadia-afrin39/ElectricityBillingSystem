...
<div class="container">
          <center><h2><u>User Info</u></h2></center> <br><br>          
		  <table class="table table-striped">
               ...
               <?php
                   $query = "SELECT * from users;"; 
                    ...
                    if($post){
						...
						<?php if(Session::get('type') == 1){ ?>
		    			<td><a class='btn btn-primary btn-xs'  href="updateUser.php?updateId=<?php echo $result['id']; ?>">Edit</a>
		    				<a class='btn btn-danger btn-xs' onclick="return confirm('Are you sure to Delete?')" href="deleteUser.php?deleteId=<?php echo $result['id']; ?>">Delete</a></td>
							<?php } ?>
						</tr>
                <?php
		    	     }
		    ...
		    <tfoot>
		    	...
		    	<td></td>
				<td></td>
		    	<td><a class="btn btn-primary" href="createUser.php">Create New Record</a></td>
		    </tfoot>
		  </table>
		</div>
 <?php } }
